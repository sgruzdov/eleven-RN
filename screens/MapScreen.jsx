...
import { Linking, Alert, Image, SafeAreaView, Text, TouchableWithoutFeedback, View, Platform } from 'react-native'
...
const MapScreen = ({ navigation }) => {
    ...
    const onCurrentPos = () => {
        getRequestPermitions().then(status => {
            getCurrentLocation(status).then(data => {
                console.log
                if (!data) {
                    return false
                }
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <Svg width="19" height="13" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <Path
                            fill={COLORS.first}
                            d="M0 11C0 11.5523 0.447715 12 1 12H17C17.5523 12 18 11.5523 18 11V11C18 10.4477 17.5523 10 17 10H1C0.447716 10 0 10.4477 0 11V11ZM0 6C0 6.55228 0.447715 7 1 7H17C17.5523 7 18 6.55228 18 6V6C18 5.44772 17.5523 5 17 5H1C0.447716 5 0 5.44772 0 6V6ZM1 0C0.447716 0 0 0.447715 0 1V1C0 1.55228 0.447715 2 1 2H17C17.5523 2 18 1.55228 18 1V1C18 0.447715 17.5523 0 17 0H1Z"
                        />
                    </Svg>
                </Button>
                <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 196 32" width="90" height="20" fill={COLORS.first}>
                    <Path
                        fillRule="evenodd"
            ...
            {location.status === 'granted' && (
                <TouchableWithoutFeedback onPress={() => navigation.navigate('Instruction')}>
                    <View
                        style={{
                ...
                <View>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    {' '}
                                    XX{selectedScooter.scooterId.toString().slice(2)}
                                </Text>
                                <View
                                    style={{
                                        marginLeft: 15,
                    ...
                    >
                        <Svg width="17" height="17" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <Path
                                d="M12 12.9375H10.5V14.4375H12V12.9375ZM10.5 4.5V12.9375H13.5V4.5H10.5ZM12 14.4375H17.625V11.4375H12V14.4375Z"
                                fill="black"
                                mask="url(#path-1-inside-1)"
                            />
                            <Path
                                d="M1.75 12C1.75 6.34135 6.34135 1.75 12 1.75C17.6587 1.75 22.25 6.34135 22.25 12C22.25 17.6587 17.6587 22.25 12 22.25C6.34135 22.25 1.75 17.6587 1.75 12Z"
                                stroke="black"
                                stroke-width="2"
                            />
                        </Svg>
            ...
            >
                ...
                >
                    <Svg width="25" height="15" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                        <Path
                            fill={locationStatus}
            ...
            <Button
                ...
                disabled={location.status === 'granted' ? false : true}
                viewStyle={{ ...COLORS.buttonShadow, height: 48 }}
            >
                <Svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 512 512">
                    ...
                    <Rect
                        ...
                        strokeWidth="32"
                    />
                    <Rect fill={locationStatus} x="96" y="336" width="80" height="80" rx="8" ry="8" />
                    <Rect
                        x="48"
                        y="288"
                        width="176"
