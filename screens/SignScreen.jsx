...
import { Text, Alert, View, Platform, SafeAreaView, TouchableWithoutFeedback, TextInput, Modal, ScrollView, Image, LayoutAnimation, UIManager, TouchableOpacity } from 'react-native'
import Svg, { Path } from 'react-native-svg'
import { BlurView } from 'expo-blur'
import { useSelector, useDispatch } from 'react-redux'

import { Context } from '../assets/context'
import { authThunk, REMOVE_ERRORS } from '../redux/reducers/authReducer'
...
const SignScreen = ({ navigation }) => {
    ...
    const handleSubmit = () => {
        if(number.length > 0) {
            dispatch(authThunk({numberCode, number}))
        }
    }
            ...
            <View style={{
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Svg style={{width: 25, height: 25, marginLeft: 10}} fill="#000" viewBox="0 0 24 24"><Path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"></Path></Svg>
                            <Text
                                style={{
                                    fontSize: 16,
                                    color: COLORS.first,
                ...
                >
                    <TouchableWithoutFeedback
                        onPress={() => setRadioButton(!radioButton)}
                    >
                        <View
                            style={{
                                width: 20,
                        ...
                        >
                            <Svg style={{width: 13, height: 13, fill: '#fff'}} viewBox="0 0 24 24"><Path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"></Path></Svg>
                        </View>
                    </TouchableWithoutFeedback>
                    <Text
                    style={{
                    ...
                    >Я принимаю условия Пользовательского соглашения, Политики конфиденциальности, Договора аренды и подтверждаю, что мне исполнилось 18 лет</Text>
                </View>
                <TouchableOpacity
                    activeOpacity={0.7}
